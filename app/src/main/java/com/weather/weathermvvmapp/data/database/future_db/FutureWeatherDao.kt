...
interface FutureWeatherDao {
    ...
    suspend fun insertFutureListAll(futureWeatherListObjectModel: List<FutureWeatherListObjectModel>)

    @Query("SELECT * FROM $FUTURE_WEATHER_DATABASE_NAME")
    suspend fun getFutureList(): List<FutureWeatherListObjectModel>
